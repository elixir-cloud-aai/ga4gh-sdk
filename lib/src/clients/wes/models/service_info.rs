...
pub struct ServiceInfo {
    ...
    pub workflow_type_versions: std::collections::HashMap<String, models::WorkflowTypeVersion>,
    ...
    pub workflow_engine_versions: std::collections::HashMap<String, String>,
    ...
    pub default_workflow_engine_parameters: Vec<models::DefaultWorkflowEngineParameter>,
...
impl ServiceInfo {
    pub fn new(id: String, name: String, r#type: models::ServiceType, organization: models::ServiceOrganization, version: String, workflow_type_versions: std::collections::HashMap<String, models::WorkflowTypeVersion>, supported_wes_versions: Vec<String>, supported_filesystem_protocols: Vec<String>, workflow_engine_versions: std::collections::HashMap<String, String>, default_workflow_engine_parameters: Vec<models::DefaultWorkflowEngineParameter>, system_state_counts: std::collections::HashMap<String, i64>, auth_instructions_url: String, tags: std::collections::HashMap<String, String>) -> ServiceInfo {
        ServiceInfo {
            id,
            name,
