...
/// WesErrorResponse : An object that can optionally include information about the error.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct WesErrorResponse {
...
impl WesErrorResponse {
    /// An object that can optionally include information about the error.
    pub fn new() -> WesErrorResponse {
        WesErrorResponse {
            msg: None,
            status_code: None,
        }
