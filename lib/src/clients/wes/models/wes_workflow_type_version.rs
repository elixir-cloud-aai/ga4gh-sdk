...
/// WesWorkflowTypeVersion : Available workflow types supported by a given instance of the service.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct WesWorkflowTypeVersion {
...
impl WesWorkflowTypeVersion {
    /// Available workflow types supported by a given instance of the service.
    pub fn new() -> WesWorkflowTypeVersion {
        WesWorkflowTypeVersion {
