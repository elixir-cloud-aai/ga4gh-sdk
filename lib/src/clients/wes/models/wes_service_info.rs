...
pub struct WesServiceInfo {
    ...
    pub workflow_type_versions: std::collections::HashMap<String, models::WesWorkflowTypeVersion>,
    ...
    pub default_workflow_engine_parameters: Vec<models::WesDefaultWorkflowEngineParameter>,
...
impl WesServiceInfo {
    pub fn new(
        id: String,
        name: String,
        r#type: models::ServiceType,
        organization: models::ServiceOrganization,
        version: String,
        workflow_type_versions: std::collections::HashMap<String, models::WesWorkflowTypeVersion>,
        supported_wes_versions: Vec<String>,
        supported_filesystem_protocols: Vec<String>,
        workflow_engine_versions: std::collections::HashMap<String, String>,
        default_workflow_engine_parameters: Vec<models::WesDefaultWorkflowEngineParameter>,
