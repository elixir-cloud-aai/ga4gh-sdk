...
pub struct WesRunLog {
    ...
    pub request: Option<Box<models::WesRunRequest>>,
    #[serde(rename = "state", skip_serializing_if = "Option::is_none")]
    pub state: Option<models::WesState>,
    #[serde(rename = "run_log", skip_serializing_if = "Option::is_none")]
    pub run_log: Option<Box<models::WesLog>>,
    ...
    pub task_logs: Option<Vec<models::WesLog>>,
