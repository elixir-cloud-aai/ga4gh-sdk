...
/// WesDefaultWorkflowEngineParameter : A message that allows one to describe default parameters for a workflow engine.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct WesDefaultWorkflowEngineParameter {
...
impl WesDefaultWorkflowEngineParameter {
    /// A message that allows one to describe default parameters for a workflow engine.
    pub fn new() -> WesDefaultWorkflowEngineParameter {
        WesDefaultWorkflowEngineParameter {
            name: None,
            r#type: None,
            default_value: None,
        }
