...
/// WesRunListResponse : The service will return a RunListResponse when receiving a successful RunListRequest.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct WesRunListResponse {
    ...
    pub runs: Option<Vec<models::WesRunStatus>>,
